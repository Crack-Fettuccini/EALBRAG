...
class TokenGeneratorWithAttention:
    ...
    def track_attention(self, attentions, input_ids):
        ...
        for layer_attention in attentions:
            ...
            important_tokens += (avg_attention > self.attention_threshold).nonzero(as_tuple=True)[1].tolist()
    ...
    def generate_tokens(self, input_prompt, max_length=100, verbose=False):
        ...
        for _ in range(max_length):
            ...
            self.memory.extend(important_tokens)
            ...
            # End generation if end-of-sequence token is reached
